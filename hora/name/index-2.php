...
<html>
    ...
    <style>
        body{background-image:url("b.jpg"); background-attachment:fixed;background-position:center;}
      ...
      <tr>
          ...
          <form id="frm" name="frm" method="get" action="index2.php" onsubmit="return check_data()">
              <table width="419" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td><span class="style12" style="font: 20pt myFont; color: #FFFFFF;" >กรุณาใส่ชื่อ</span></td>
                  <td><font face="MS Sans Serif, Tahoma, sans-serif" size="2">
                    <input size="34" name="name" id="name">
                  </font></td>
                </tr>
                <tr>
                  <td><span class="style12" style="font: 20pt myFont; color: #FFFFFF;" >กรุณาใส่นามสกุล</span></td>
                  <td><font face="MS Sans Serif, Tahoma, sans-serif" size="2">
...
<?php  if(!empty($_REQUEST["name"])) echo ' 
    <table width="1242" cellpadding="3" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFDBB8" style="font:19pt myFont;">
        <tbody>  
            <tr>
            ...
            <td class="text" bgcolor="#FFCC66">	
				...
				<?php
				if($rahu>3) echo "<font color=red size=4>   ** หมายเหตุ : ชีวิตจะเหนื่อย เดือดร้อนมีแต่เรื่องวุ่นวาย เป็นหนี้เป็นสิน โรคร้ายอุบัติเหตุ หลุมหลงมัวเมา อะไรง่ายๆ  เป็นหญิง ความรักครอบครัว จะล้มเหลว</font>" ;
				//echo $rahu;
				if(strstr($str,"ตร")|| strstr($str,"รด")||strstr($str,"ลด")||strstr($str,"ตล")||strstr($str,"ตย")||strstr($str,"ตว")) echo "<font color=red size=4>    ให้ระวัง อุบัตเหตุการณ์ฝ่าตัด ชีวิตจะเหนื่อย เดือดร้อนมีแต่เรื่องวุ่นวาย เป็นหนี้เป็นสิน</font>" ; 
				if(mb_substr($str,mb_strlen($str,'utf-8')-1,1,'utf-8')=="ต") echo "<font color=red size=4>    ให้ระวังอุบัติเหตุ การผ่าตัด ผ่าเจาะ บาดเเผล บาดเจ็บ</font>" ; 
				if(mb_substr($str,mb_strlen($str,'utf-8')-2,2,'utf-8')=="ด์"||mb_substr($str,mb_strlen($str,'utf-8')-2,2,'utf-8')=="ต์"||mb_substr($str,mb_strlen($str,'utf-8')-2,2,'utf-8')=="ค์"||substr_count($str,"ตต") >2) echo "<font color=red size=4>     ระวังอุบัติเหตุ การผ่าตัด</font>" ; 
				if(mb_substr($str,mb_strlen($str,'utf-8')-1,1,'utf-8')=="ศ"||mb_substr($str,mb_strlen($str,'utf-8')-1,1,'utf-8')=="ส") echo "<font color=red size=4>   ให้ระวังเจ็บป่วย ชีวิตทุกข์วุ่นวาย</font>" ; 
				?>
            </td>
            </tr>
        </tbody>
    ...
    <table width="1242" cellpadding="3" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" style="font:19pt myFont;">
        <tbody>  
            <tr>
                <td align="left" bgcolor="#FF6600"><strong><span class="style14">&nbsp;&nbsp;</span><span class="textYellow">&nbsp;พลังอายตนะ พลังเงา และ พลังสะท้อน ได้ผลดังนี้</span></strong></td>
            </tr>
			<?php  if(!empty($_REQUEST["name"])) echo ' 
            <tr>
				<td class="text" bgcolor="#FFCC66">&nbsp;&nbsp;&nbsp;
			...
			<tr>
				<td class="text" bgcolor="#FFCC66">&nbsp;&nbsp;&nbsp;
					<font color=red>พลังเงา '.$str.' หมายเลข '.$num_keep.' </font> '.$result5['detail'].'
				</td>
            </tr>  ';?> 
            </tr>
				<td class="text" bgcolor="#FFCC66">&nbsp;&nbsp;&nbsp;
...
<table width="742" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#00000" bgcolor="#ECFFDA" >
    ...
    <tbody><tr>
            <td align="center" bgcolor="#CCFF99"><span class="style21"><strong><span class="style22"><?php echo $str ?>  </span><span class="style22">เกิด </span><span class="style22">
			<?php switch($num_day){
		 case 0 : echo "วันอาทิตย์ "; break;
		 case 1 : echo "วันศุกร์ "; break;
		 case 2 : echo "วันพุธกลางคืน"; break;
		 case 3 : echo "วันพฤหัสบดี"; break;
		 case 4 : echo "วันเสาร์"; break;
		 case 5 : echo "วันพุธกลางวัน "; break;
		 case 6 : echo "วันอังคาร"; break;
			case 7 : echo "วันจันทร์ "; break;} ?>
